from CatmaidCode import CustomNeuronClassSet as CN
import json
import os
import colour
from collections import defaultdict, OrderedDict

#To create of another set, make set in CNCS ex: joNeurons
#and then do specific lines to make json or gradients won't color properly
# quickly creates a JSON of GF neurons in the RGB value given
def colorExampleJSON(rgb, opacity = 1, rgb2 = None):
    aListofNeurons = []
    GF1 = {
            "skeleton_id": 4947529,
            "color": rgb,
    ...
    c = open("C:/Users/tenshawe/Desktop/pyCharmOutputs/JSON/GFColorTest.json", 'w')
    c.write(myJSON)
    c.close()
    return
...
# creates JSON here "C:/Users/tenshawe/Desktop/pyCharmOutputs/JSON"
def createJSON(mySet, colorVariable='SynapseCount', colorVariable2='Default'):
    ...
    copyNumber = 0
    fileName = colorVariable2 + '_' + colorVariable + '.json'
    pathVar = "C:/Users/tenshawe/Desktop/pyCharmOutputs/JSON/Colored"
...
# colors neurons by their modality
...
def moreThan100(mySet):
    ...
    mySetCopy = CN.GFIN_set(mySetCopy)
    return mySetCopy
