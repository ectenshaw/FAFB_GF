...
class DNinputNeuron(object):
    ...
    def __init__(self, skeletonID):
        ...
        self.percentCurrentGroup = 0  # percent of DNrightsynapses relative to other neurons in the current sub-group
        #  of DNrightinput neurons
        self.soma = None
        self.skeletonNodes = None

        # connectorIDs is all of this neuron's connectors, not just DNinput neurons, in order to get that info: run
        # getAllDNINSynByBranch for the set and it will fill synLocation attribute
    ...
    def getConnectorIDs(self, polarity = 'presynaptic'):
        self.connectorIDs = getSkeletonNodesNew.getAllConnectors(skeletonID=self.skeletonID, polarity=polarity)
