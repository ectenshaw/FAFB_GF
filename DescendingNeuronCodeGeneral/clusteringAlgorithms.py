import sklearn
import MyCustomDNNeuronClass as CN
...
#myclusters should be dictionary of lists of skids (as returned by above function), returns list containing DNIN_sets
...
#myclusters should be dictionary of lists of connectorIDs (as returned by above function), returns list containing DNIN_sets
#def createSet(myClusters):
    '''myBigSet = [] 
    count = 0
    for item in myClusters:
